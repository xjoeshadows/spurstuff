...
if __name__ == "__main__":
    # Start the macro timer to track total time running from script launch
    ...
    with open(no_enrich_file, 'r', encoding='utf-8') as f:
        for i, line in enumerate(f):
            ...
            # Print heartbeat every 25,000 lines
            if (i + 1) % 25000 == 0:
    ...
    print("  1: Terminal Input (Apply identical dates/arrays to ALL records)")
    print("  2: Spreadsheet Mapping (Map specific dates/arrays to specific IPs)")
    print("-" * 50)
    ...
    # Start the clock right before network execution begins for accurate RPS tracking
    ...
    # Use start_main_time here to show how long the ENTIRE script took from launch
