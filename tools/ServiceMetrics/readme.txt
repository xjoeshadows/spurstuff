...
servicemetrics-manual-diff-enrich.py: will do a diff the same as the previous diff script, but will also then enrich each of the added tags against the tag lookup API and output a jsonl of the details for each tag
